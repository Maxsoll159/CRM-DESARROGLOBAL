                                ...
                                <Popover.Panel className="fixed z-10 -translate-x-1/2 -translate-y-[30%] transform px-3 sm:px-0 w-[150px] left-[96%] ">
                                    <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                                        <div className="relative bg-white p-2">
                                            ...
                                            <Link href={`dashboard/${tipo}/${tipo === "certificado" ? "detallecertificado": "   "}/${id}`} className='capitalize flex items-center gap-2 font-medium p-1 hover:text-blue-500'><i className="fi fi-rr-edit flex items-center"></i>Editar</Link>
